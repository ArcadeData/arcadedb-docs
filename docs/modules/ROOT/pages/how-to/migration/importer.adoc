...
- xref:reference/sql/sql-database-admin.adoc#sql-import-database[SQL Import Database command],
...
The Importer takes additional settings as pairs of setting name and value. With the SQL xref:reference/sql/sql-database-admin.adoc#sql-import-database[`IMPORT DATABASE`] command, this is the syntax:
