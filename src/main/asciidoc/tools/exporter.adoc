[[Exporter]]
=== Exporter
image:../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/tools/exporter.adoc" float=right]

ArcadeDB is able to export a database in JSONL format. JSONL creates one line per JSON.
