...
To import a database use the xref:reference/sql/sql-import-database.adoc#sql-import-database[Import Database] command from API, Studio or Console. Below you can find an example of importing a OrientDB database by using ArcadeDB xref:tools/console.adoc#console[Console].
