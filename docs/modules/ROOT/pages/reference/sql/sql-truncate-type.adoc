...
[discrete]
= SQL - `TRUNCATE TYPE`
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/sql/sql-truncate-type.adoc" float=right]
...
* xref:reference/sql/sql-truncate-bucket.adoc#sql-truncate-bucket[`TRUNCATE BUCKET`]
