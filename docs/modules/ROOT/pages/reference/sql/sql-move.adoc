...
[discrete]
= SQL - `MOVE VERTEX`
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/sql/sql-move.adoc" float=right]
...
NOTE: This is command is similar to the xref:reference/sql/sql-update.adoc#sql-update[UPDATE] command.
