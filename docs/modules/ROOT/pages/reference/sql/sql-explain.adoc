...
[discrete]
= SQL - `EXPLAIN`
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/sql/sql-explain.adoc" float=right]
...
* xref:reference/sql/chapter.adoc#sql-commands[ SQL Commands]
* xref:reference/sql/sql-profile.adoc#sql-profile[PROFILE]
