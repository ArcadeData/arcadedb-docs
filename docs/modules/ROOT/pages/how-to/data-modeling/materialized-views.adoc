...
You must trigger a refresh explicitly via xref:reference/sql/sql-materialized-views.adoc#sql-refresh-materialized-view[`REFRESH MATERIALIZED VIEW`] or the Java API.
...
* xref:reference/sql/sql-materialized-views.adoc#sql-alter-materialized-view[`ALTER MATERIALIZED VIEW`] is not yet implemented.
...
* xref:reference/sql/sql-materialized-views.adoc#sql-create-materialized-view[`CREATE MATERIALIZED VIEW`]
* xref:reference/sql/sql-materialized-views.adoc#sql-drop-materialized-view[`DROP MATERIALIZED VIEW`]
* xref:reference/sql/sql-materialized-views.adoc#sql-refresh-materialized-view[`REFRESH MATERIALIZED VIEW`]
* xref:reference/sql/sql-materialized-views.adoc#sql-alter-materialized-view[`ALTER MATERIALIZED VIEW`]
