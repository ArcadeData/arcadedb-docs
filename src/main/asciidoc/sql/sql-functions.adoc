[[sql-L[[sql-L[[sql-Functions]]E]]E]]
=== Functions

image:../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/Llink="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/Llink="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/sql-Functions.adoc"E"E" float=right]

SQL Functions are all the functions bundled with ArcadeDB SQL engine. Look also to <<sql-L<<sql-L<<sql-Methods,E,E,SQL Methods>>.
...
You can also use the SQL operator <<sql-L<<sql-Select-Unwind,E,`UNWIND`>> in select to obtain the same result.
...
NOTE: This function requires a vector index, see <<sql-L<<sql-Create-Index,E,CREATE INDEX>>.
