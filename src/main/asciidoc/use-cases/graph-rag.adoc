...
*Hybrid Retrieval (Dense + Sparse), one query* -- The canonical modern-RAG retrieval shape. Dense + sparse hybrid with Reciprocal Rank Fusion, deduped to one chunk per source document via `groupBy`:
