[[jdbc]]
= JDBC Driver
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/how-to/connectivity/jdbc.adoc" float=right]

If you're using Java you can use the Postgres JDBC driver. This means the xref:how-to/connectivity/postgres.adoc#postgres-driver[Postgres Plugin] needs to be loaded by the server.
