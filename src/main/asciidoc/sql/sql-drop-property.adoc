[[sql-L[[sql-Drop-Property]]E]]
[discrete]

=== SQL - `DROP PROPERTY`

image:../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/Llink="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/sql-Drop-Property.adoc"E" float=right]
...
* <<sql-L<<sql-alter-property,E,`ALTER PROPERTY`>>
* <<sql-L<<sql-create-property,E,`CREATE PROPERTY`>>