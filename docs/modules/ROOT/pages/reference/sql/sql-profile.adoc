...
[discrete]
= SQL - `PROFILE`
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/sql/sql-profile.adoc" float=right]
...
The result is the execution plan of the query (like for xref:reference/sql/sql-explain.adoc#sql-explain[EXPLAIN] ) with additional information about execution time spent on each step, in microseconds.
...
* xref:reference/sql/sql-explain.adoc#sql-explain[EXPLAIN]
