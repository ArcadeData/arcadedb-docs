[[sql-L[[sql-L[[sql-Explain]]E]]E]]
[discrete]

=== SQL - `EXPLAIN`

image:../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/Llink="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/Llink="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/sql-Explain.adoc"E"E" float=right]
...
* <<sql-L<<sql-L<<sql-Commands,E,E,SQL Commands>>
* <<sql-L<<sql-L<<sql-Profile,E,E,PROFILE>>