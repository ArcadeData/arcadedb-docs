...
ArcadeDB runs on the Java Runtime Environment (JRE) in https://en.wikipedia.org/wiki/Java_version_history[versions] *17* and *21* (LTS);
tested JREs are:

* https://openjdk.org/[OpenJDK] 17 is compatible,
