...
|`dateImplementation`|Date implementation to use on deserialization. Supported are: `"java.util.Calendar"`, `"java.time.LocalDate"`|String|`"java.util.Date"`
|`dateTimeImplementation`|Datetime implementation to use on deserialization. Supported are: `"java.util.Calendar"`, `"java.time.LocalDateTime"`, `"java.time.ZonedDateTime"`|String|`"java.util.Date"`
|`dateTimePrecision`|Precision to use with Datetime types on deserialization. Check the level of precision supported by your OS/JVM. Supported are: `"millisecond"`, `"microsecond"` and `"nanosecond"`|String|`"millisecond"`
