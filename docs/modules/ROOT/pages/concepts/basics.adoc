...
When you create a new record, ArcadeDB selects the bucket to store it in using a xref:reference/sql/sql-types.adoc#bucket-selection[configurable strategy].
