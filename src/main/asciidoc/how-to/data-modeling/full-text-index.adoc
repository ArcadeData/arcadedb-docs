[[full-text-index]]
==== Full-Text Index
image:../../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/how-to/data-modeling/full-text-index.adoc" float=right]
