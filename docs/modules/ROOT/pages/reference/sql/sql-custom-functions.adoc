[[user-functions]]
= User Functions
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/sql/sql-custom-functions.adoc" float=right]
...
Look at the xref:concepts/basics.adoc#database-url[Database Interface] page for built-in database functions.
