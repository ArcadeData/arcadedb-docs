...
include::path-finding.adoc[]

include::centrality.adoc[]

include::community-detection.adoc[]

include::structural-analysis.adoc[]

include::similarity-link-prediction.adoc[]

include::network-flow.adoc[]

include::traversal-sampling.adoc[]

include::network-science.adoc[]

include::community-quality.adoc[]

include::graph-statistics.adoc[]

include::node-embedding.adoc[]

include::sql-path-functions.adoc[]
