...
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/cypher/cypher-expressions.adoc" float=right]
...
For a complete list of available SQL functions, see the xref:reference/sql/sql-functions.adoc#sql-functions[SQL Functions] reference.
...
For the complete function reference, see xref:reference/extended-functions.adoc#extended-functions[].
