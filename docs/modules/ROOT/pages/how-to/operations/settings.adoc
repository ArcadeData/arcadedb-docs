[[changing-settings]]
= Changing Settings
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/how-to/operations/settings.adoc" float="right"]
...
Check the xref:reference/settings.adoc#settings-sql[Appendix] for all the available settings.
...
Setting a profile is like executing a macro that changes multiple settings at once. You can tune them individually, check xref:reference/settings.adoc#settings-sql[Settings].
