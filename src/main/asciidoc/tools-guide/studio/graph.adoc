...
See <<appendix-graph-algorithms,Graph Algorithms Appendix>> for algorithm details, advanced usage, and the full library of graph algorithms available via Cypher and SQL.
