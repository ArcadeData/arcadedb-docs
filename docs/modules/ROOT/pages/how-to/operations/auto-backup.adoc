...
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/how-to/operations/auto-backup.adoc" float=right]
...
See xref:tools/studio/server.adoc#studio-backup[Studio Backup Panel] for details.

image::studio-server-backup.png[Studio Server Backup Panel]
