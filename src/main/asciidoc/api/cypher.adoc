...
Based on some internal benchmarks, ArcadeDB's native SQL (<<sql-L<<sql-Select,E,SELECT>> or <<sql-L<<sql-Match,E,MATCH>>) is much faster than Cypher (even 2,000% faster!).
