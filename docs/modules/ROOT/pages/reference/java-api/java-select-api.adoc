[[java-select-api]]
= Native Select API
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/java-api/java-select-api.adoc" float=right]
...
It requires a xref:reference/java-api/java-vectors.adoc#java-vectors[vector index] on the target property.
