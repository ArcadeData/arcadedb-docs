...
The response contains the name of available database in the "result" array. Example:

```json
{"result":["Movies","Universe"],"user":"root","version":"22.1.3-SNAPSHOT (build 0454b5b18e33aa79ccaeff780e75adf5af4c1d25/1641970368529/main)"}
```
