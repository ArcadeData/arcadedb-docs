...
Creates a point from two numbers specifying X- and Y-coordinate.
...
Creates a circle from two numbers specifying X- and Y-coordinate of circle's center and a number describing the circle's radius.
...
[source,sql]
----
SELECT circle(10,10,10) AS circ
----
...
Creates a rectangle from four numbers specifying the left boundary X-, top boundary Y-, right boundary X- and botton boundary Y-values.
...
[source,sql]
----
SELECT rectangle(10,10,20,20) AS rect
----
...
Creates a string of lines from a list of points.
...
[source,sql]
----
SELECT lineString( [ point(10,10), point(20,10), point(20,20), point(10,20), point(10,10) ] ) AS lines
----
...
[source,sql]
----
SELECT polygon( [ point(10,10), point(20,10), point(20,20), point(10,20), point(10,10) ] ) AS poly
----
