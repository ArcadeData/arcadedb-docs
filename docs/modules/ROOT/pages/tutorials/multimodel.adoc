...
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/tutorials/multimodel.adoc" float="right"]
...
Such a full-text index is xref:reference/sql/sql-create-index.adoc#sql-create-index[created just like any index] in ArcadeDB.
