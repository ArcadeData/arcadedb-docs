...
In the event that these default formats are not sufficient for the needs of your application, you can customize them through xref:reference/sql/sql-database-admin.adoc#sql-alter-database[`ALTER DATABASE ... DATEFORMAT`] and xref:reference/sql/sql-database-admin.adoc#sql-alter-database[`DATETIMEFORMAT`] commands.
For instance,
