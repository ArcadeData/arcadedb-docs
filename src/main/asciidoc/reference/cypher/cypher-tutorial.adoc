...
[TIP]
====
Prefer a guided, video-based walkthrough? The https://arcadedb.com/academy/graph-cypher.html[ArcadeDB Academy] offers a *free* course on Cypher with hands-on exercises and a certification at the end.
====
