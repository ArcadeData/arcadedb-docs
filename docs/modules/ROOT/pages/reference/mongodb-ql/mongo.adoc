...
If you want to use MongoDB Query Language from xref:reference/java-api/java-ref-database.adoc#database-api[Java API], you can simply keep the relevant jars in your classpath and execute a query or a command with "mongo" as language.
