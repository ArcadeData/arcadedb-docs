...
```shell
docker run --rm -p 2480:2480 -p 2424:2424 -p 5432:5432 -e arcadedb.server.rootPassword=playwithdata -e arcadedb.server.plugins="Postgres:com.arcadedb.postgres.PostgresProtocolPlugin" arcadedata/arcadedb:latest
```
