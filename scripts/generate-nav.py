...
NAV_STRUCTURE: list[dict] = [
    {
        ...
        "groups": [
            ...
            ("Self-Managed Deployment", [
                ...
                ("how-to/operations/logging.adoc", "Logging"),
            ...
            ("Tools", [
                (("tools/studio/main.adoc", "Studio"), [
                    ("tools/studio/query.adoc", "Query"),
                    ("tools/studio/database.adoc", "Database"),
                    ("tools/studio/timeseries.adoc", "TimeSeries"),
                    ("tools/studio/server.adoc", "Server"),
                    ("tools/studio/profiler.adoc", "Profiler"),
                    ("tools/studio/security.adoc", "Security"),
                    ("tools/studio/cluster.adoc", "Cluster"),
                    ("tools/studio/api.adoc", "API"),
                    ("tools/studio/information.adoc", "Info"),
                    ("tools/studio/ai.adoc", "AI Assistant"),
                    ("tools/studio/settings.adoc", "Settings"),
                ]),
                "tools/console.adoc",
