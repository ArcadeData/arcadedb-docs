...
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/tutorials/remote-tutorial.adoc" float=right]
...
For more detailed information about the HTTP/JSON protocol, see the xref:reference/http-api/http.adoc#http-json-api[HTTP/JSON API] section.
