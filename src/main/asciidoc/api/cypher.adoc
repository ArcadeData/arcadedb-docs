...
Based on some internal benchmarks, ArcadeDB's native SQL (<<sql-select,E,SELECT>> or <<sql-match,E,MATCH>>) is much faster than Cypher (even 2,000% faster!).
