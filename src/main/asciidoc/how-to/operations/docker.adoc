[[docker]]
==== Docker
image:../../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/how-to/operations/docker.adoc" float="right"]

To run the ArcadeDB server with Docker, type this (replace <password> with the root password you want to use):

[source,shell,subs="attributes+"]
----
$ docker run --rm -p 2480:2480 -p 2424:2424 -p 2434:2434 --name my_arcadedb \
...
[source,shell]
----
$ docker run --rm  -p 2480:2480 -p 2424:2424 -p 2434:2434 -p 6379:6379 -p 5432:5432 -p 8182:8182 --env JAVA_OPTS="\
