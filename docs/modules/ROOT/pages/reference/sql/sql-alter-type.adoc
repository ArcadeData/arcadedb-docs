...
[discrete]
= SQL - `ALTER TYPE`
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/sql/sql-alter-type.adoc" float=right]
...
* xref:reference/sql/sql-create-type.adoc#sql-create-type[`CREATE TYPE`]
