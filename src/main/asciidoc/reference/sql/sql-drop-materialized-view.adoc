...
[discrete]
==== SQL - `DROP MATERIALIZED VIEW`
image:../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/sql/sql-drop-materialized-view.adoc" float=right]
