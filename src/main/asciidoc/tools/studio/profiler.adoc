...
Step timings are the time each step spent in its *own* work, summed over every occurrence of that step across all the executions of the query.
They are therefore contained in the query's *Engine* total and never larger than it.
