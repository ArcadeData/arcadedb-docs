...
[NOTE]
====
Since v26.10.1. Before, a malformed line was only logged and the request answered `204`, and a field missing its value
at the end of a line was stored as `0.0` instead of rejecting the line.
====
