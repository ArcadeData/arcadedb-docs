...
See also: xref:reference/sql/sql-functions.adoc#dijkstra[dijkstra()] in SQL Functions reference and xref:reference/graph-algorithms/path-finding.adoc#algo-dijkstra[] for the Cypher procedure variant.
...
See also: xref:reference/graph-algorithms/path-finding.adoc#algo-bellman-ford[] for the Cypher procedure variant.
