[[graph-database]]
= Graph Database
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/concepts/graphs.adoc" float=right]
...
* xref:use-cases/recommendation-engine.adoc#use-case-recommendation-engine[Recommendation Engine] -- Use case combining graph traversals with collaborative filtering
* xref:use-cases/fraud-detection.adoc#use-case-fraud-detection[Fraud Detection] -- Use case leveraging graph patterns to detect fraudulent activity
* xref:reference/gremlin/gremlin.adoc#gremlin-api[Gremlin API] -- Tinkerpop Gremlin query language for graph traversals
* xref:reference/cypher/chapter.adoc#cypher[Cypher] -- OpenCypher query language for pattern matching on graphs
