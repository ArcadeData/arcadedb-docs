...
* xref:how-to/connectivity/http-nodejs.adoc[*HTTP/JSON API*] -- use `fetch` or `axios`, no driver required.
...
* <<sql,SQL Reference>>
* <<http-json-api,HTTP/JSON API>> -- Alternative: use `fetch()` with ArcadeDB's REST API
