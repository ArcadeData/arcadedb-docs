...
If you're using the xref:concepts/multi-model.adoc#document-model[Document Model] and links to connect documents, then you can map 1-1 the GraphQL type to ArcadeDB type.
Example:
...
If you're using a xref:concepts/multi-model.adoc#graph-model[Graph Model] for your domain, then you need to declare with a GraphQL directive how the relationship is translated on the graph model.
