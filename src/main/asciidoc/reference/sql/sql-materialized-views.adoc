...
* *`IF NOT EXISTS`* Silently skips creation if a view with the same name already exists, instead of raising an error. See <<sql-if-not-exists-result,here>> for the shape of the result.
