...
For an end-to-end multi-statement version (with retry on conflict), see xref:reference/sql/sql-script.adoc#sql-script[SQL Script].

For more information, see:

* xref:reference/sql/sql-create-vertex.adoc#sql-create-vertex[`CREATE VERTEX`]
