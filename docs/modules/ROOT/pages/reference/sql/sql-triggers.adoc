...
[discrete]
= Triggers
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/sql/sql-triggers.adoc" float=right]
...
* xref:reference/sql/sql-create-trigger.adoc#sql-create-trigger[CREATE TRIGGER]
* xref:reference/sql/sql-drop-trigger.adoc#sql-drop-trigger[DROP TRIGGER]
* xref:reference/sql/sql-script.adoc#sql-script[SQL Script]
* xref:reference/sql/sql-custom-functions.adoc#user-functions[User Functions]
