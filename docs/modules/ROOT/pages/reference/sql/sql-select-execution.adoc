...
To display the execution plan of a query, without executing it, you can just execute the query prefixing it with xref:reference/sql/sql-inspection.adoc#sql-explain[`EXPLAIN`], eg.
