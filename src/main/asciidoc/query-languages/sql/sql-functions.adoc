...
0 means orthogonal, 1 means identical direction.
...
Syntax: `VECTOR_AVG(<vector_column>)`

*Examples*

[source,sql]
----
SELECT category, VECTOR_AVG(embedding) as centroid FROM Document GROUP BY category
----
...
Syntax: `VECTOR_SUM(<vector_column>)`

*Examples*

[source,sql]
----
SELECT VECTOR_SUM(embedding) as total_vector FROM Document WHERE active = true
----
...
Syntax: `VECTOR_MIN(<vector_column>)`

*Examples*

[source,sql]
----
SELECT VECTOR_MIN(embedding) as min_bounds FROM Document WHERE category = 'science'
----
...
Syntax: `VECTOR_MAX(<vector_column>)`

*Examples*

[source,sql]
----
SELECT VECTOR_MAX(embedding) as max_bounds FROM Document WHERE category = 'science'
----
...
Syntax: `sparseVectorCreate(<indices>, <values>, [<dimensions>])`

*Examples*

[source,sql]
----
SELECT sparseVectorCreate([0, 3, 5], [1.0, 2.5, 0.3], 768) as sparse_embedding
----
...
Syntax: `sparseVectorDot(<sparse_vector1>, <sparse_vector2>)`

*Examples*

[source,sql]
----
SELECT sparseVectorDot(doc1.sparse_embedding, query.sparse_embedding) as similarity
----
...
Syntax: `sparseVectorToDense(<sparse_vector>, <dimensions>)`

*Examples*

[source,sql]
----
SELECT sparseVectorToDense(sparse_embedding, 768) as dense_embedding FROM Document
----
...
Syntax: `denseVectorToSparse(<vector>, [<threshold>])`

*Examples*

[source,sql]
----
SELECT denseVectorToSparse(embedding, 0.001) as sparse_embedding FROM Document
----
...
Syntax: `multiVectorScore(<scores_array>, <method>, [<weights>])`

*Examples*

[source,sql]
----
SELECT multiVectorScore([0.9, 0.8, 0.85], 'MAX') as best_score
----
...
[source,sql]
----
SELECT vectorHasNaN([1.0, 2.0, null]) as has_nan
----
