[[importer]]
= Importer
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/how-to/migration/importer.adoc" float=right]
...
- Generic XML files
- Generic xref:how-to/migration/json-importer.adoc#json-importer[JSON] files
- Generic JSONL files
- Generic CSV files
- Generic RDF files
...
- xref:reference/sql/sql-import-database.adoc#sql-import-database[SQL Import Database command],
- xref:how-to/migration/graph-importer.adoc#graph-importer[Graph Importer] (high-performance, declarative graph import from XML, CSV, JSONL with JSON configuration)
- xref:how-to/migration/json-importer.adoc#json-importer[JSON Importer]
- xref:how-to/migration/neo4j-importer.adoc#neo4j-importer[Neo4j Importer],
- xref:how-to/migration/orientdb-importer.adoc#orientdb-importer[OrientDB Importer]

== Additional Settings

The Importer takes additional settings as pairs of setting name and value. With the SQL xref:reference/sql/sql-import-database.adoc#sql-import-database[`IMPORT DATABASE`] command, this is the syntax:
...
| distanceFunction | `innerproduct` | Type of distance measure, see xref:tutorials/multimodel.adoc#similarity[similarity measures].
