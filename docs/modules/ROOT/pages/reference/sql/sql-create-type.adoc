...
[discrete]
= SQL - `CREATE TYPE`
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/sql/sql-create-type.adoc" float=right]
...
strategy for the type using the xref:reference/sql/sql-alter-type.adoc#sql-alter-type[`ALTER TYPE`] command.
...
* xref:reference/sql/sql-drop-type.adoc#sql-drop-type[`DROP TYPE`]
* xref:reference/sql/sql-create-bucket.adoc#sql-create-bucket[`CREATE BUCKET`]
