[[java-api-grpc]]
= Java API (gRPC)
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/java-api/java-api-grpc.adoc" float=right]
...
* xref:reference/java-api/java-api-remote.adoc#java-api-remote[Java API (Remote)] - HTTP-based remote API
* xref:reference/java-api/java-api-local.adoc#java-api-local[Java API (Local)] - Embedded database API
* xref:reference/java-api/java-reference.adoc#java-reference[Java API Reference] - Complete API documentation
