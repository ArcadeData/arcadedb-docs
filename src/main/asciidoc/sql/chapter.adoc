...
| | |  | <<SQL-Check-Database,CHECK DATABASE>>
| | |  | <<SQL-Align-Database,ALIGN DATABASE>>
|===
...
include::SQL-Align-Database.md[]

include::SQL-Alter-Database.md[]

include::SQL-Alter-Property.md[]
