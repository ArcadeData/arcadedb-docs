[[upgrade]]
= Upgrade ArcadeDB
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/how-to/operations/upgrade.adoc" float=right]
...
2. Stop any ArcadeDB running servers (or close manually the database by using the HTTP command "xref:reference/http-api/http.adoc#http-servercommand[close database]").
