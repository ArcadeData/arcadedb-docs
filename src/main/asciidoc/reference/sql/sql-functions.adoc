...
Both forms work identically and can be used interchangeably. The namespaced form (`vector.*`) is recommended for new code and is documented in <<extended-functions>>.
====
