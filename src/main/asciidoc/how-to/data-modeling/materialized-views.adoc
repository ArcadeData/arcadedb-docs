[[materialized-views]]
==== Materialized Views
image:../../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/how-to/data-modeling/materialized-views.adoc" float=right]
