...
See also: <<algo-dijkstra-sql>> for the SQL function variant, and xref:reference/sql/sql-functions.adoc#astar[astar()] / xref:reference/sql/sql-functions.adoc#dijkstra[dijkstra()] for the SQL function equivalents.
...
See also: xref:reference/sql/sql-functions.adoc#dijkstra[dijkstra()] in SQL Functions reference and <<algo-dijkstra>> for the Cypher procedure variant.
...
See also: xref:reference/sql/sql-functions.adoc#shortest-path-function[shortestPath()] in SQL Functions reference.
