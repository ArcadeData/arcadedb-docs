...
++++
<svg class="dgm-svg" viewBox="0 0 1200 280"
     xmlns="http://www.w3.org/2000/svg"
     role="img" aria-label="Type Administrator~User extends both Administrator and User types.">
  <g class="dgm-box dgm-box-blue">
    <rect x="420" y="30" width="360" height="80" rx="8"/>
    <text x="600" y="78" text-anchor="middle" class="dgm-title">Administrator~User</text>
  </g>
  <g class="dgm-box dgm-box-purple">
    <rect x="80" y="170" width="320" height="80" rx="8"/>
    <text x="240" y="218" text-anchor="middle" class="dgm-title">Administrator</text>
  </g>
  <g class="dgm-box dgm-box-green">
    <rect x="800" y="170" width="320" height="80" rx="8"/>
    <text x="960" y="218" text-anchor="middle" class="dgm-title">User</text>
  </g>
  <line x1="500" y1="110" x2="280" y2="170" class="dgm-conn"/>
  <line x1="700" y1="110" x2="920" y2="170" class="dgm-conn"/>
</svg>
++++
