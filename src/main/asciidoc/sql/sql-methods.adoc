[[sql-L[[sql-L[[sql-Methods]]E]]E]]
=== Methods

image:../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/Llink="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/Llink="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/sql-Methods.adoc"E"E" float=right]

SQL Methods are similar to <<sql-L<<sql-L<<sql-Functions,E,E,SQL Functions>> but they apply to values.
...
This is a <<sql-L<<sql-L<<sql-Functions,E,E,SQL Function>>:
...
NOTE: This method first converts its input to a string and then returns the string's length. For obtaining a collection's lengths use the <<_size,size()>> method.
