...
* xref:reference/java-api/java-ref-database.adoc#database-api[Java API (Local)] - Embedded database API
* xref:reference/java-api/java-ref-database.adoc#database-api[Java API Reference] - Complete API documentation
