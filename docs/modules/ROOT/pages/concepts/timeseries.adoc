[[timeseries]]
= Time Series
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/concepts/timeseries.adoc" float=right]
...
* xref:tutorials/time-series-tutorial.adoc#time-series-tutorial[Time Series Tutorial] -- Step-by-step hands-on guide to time series in ArcadeDB
* xref:use-cases/realtime-analytics.adoc#use-case-realtime-analytics[Realtime Analytics] -- Use case for streaming ingestion and real-time dashboards
