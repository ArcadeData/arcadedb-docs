...
NAV_STRUCTURE: list[dict] = [
    {
        ...
        "groups": [
            ...
            ("Tools", [
                ("Studio", [
                    ("tools/studio/main.adoc", "Overview"),
                    ("tools/studio/database.adoc", "Database"),
                    ("tools/studio/graph.adoc", "Graph"),
                    ("tools/studio/table.adoc", "Table"),
                    ("tools/studio/json.adoc", "JSON"),
                    ("tools/studio/information.adoc", "Information"),
