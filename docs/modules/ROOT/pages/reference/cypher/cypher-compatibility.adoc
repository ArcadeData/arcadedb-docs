...
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/cypher/cypher-compatibility.adoc" float=right]
...
See xref:reference/sql/sql-custom-functions.adoc#user-functions[User Functions] for complete documentation.
