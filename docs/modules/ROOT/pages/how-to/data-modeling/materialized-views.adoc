[[materialized-views]]
= Materialized Views
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/how-to/data-modeling/materialized-views.adoc" float=right]
...
You must trigger a refresh explicitly via xref:reference/sql/sql-refresh-materialized-view.adoc#sql-refresh-materialized-view[`REFRESH MATERIALIZED VIEW`] or the Java API.
...
* xref:reference/sql/sql-alter-materialized-view.adoc#sql-alter-materialized-view[`ALTER MATERIALIZED VIEW`] is not yet implemented.
...
* xref:reference/sql/sql-drop-materialized-view.adoc#sql-drop-materialized-view[`DROP MATERIALIZED VIEW`]
* xref:reference/sql/sql-refresh-materialized-view.adoc#sql-refresh-materialized-view[`REFRESH MATERIALIZED VIEW`]
* xref:reference/sql/sql-alter-materialized-view.adoc#sql-alter-materialized-view[`ALTER MATERIALIZED VIEW`]
