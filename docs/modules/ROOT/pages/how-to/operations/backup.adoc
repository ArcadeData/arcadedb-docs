...
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/how-to/operations/backup.adoc" float=right]
...
* **Automatic backup** - Schedule recurring backups with retention policies (see xref:how-to/operations/auto-backup.adoc#auto-backup[Automatic Backup Scheduler])

For manual backups, you can execute the backup of a database from SQL.
Look at xref:reference/sql/sql-backup-database.adoc#sql-backup-database[Backup Database SQL command] for more information.
