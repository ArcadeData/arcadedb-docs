[[sql-methods]]
= Methods
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/sql/sql-methods.adoc" float=right]

SQL Methods are similar to xref:reference/sql/sql-functions.adoc#sql-functions[SQL Functions] but they apply to values.
...
This is a xref:reference/sql/sql-functions.adoc#sql-functions[SQL Function]:
...
NOTE: The admissible argument values are given xref:reference/managing-dates.adoc#time-units[here].
...
The potential return values are listed as "*SQL type*" xref:reference/datatypes.adoc#datatypes[here].
