...
NOTE: Changing precision after data has been indexed requires rebuilding the index with xref:reference/sql/sql-indexes.adoc#sql-rebuild-index[`REBUILD INDEX`].
...
* xref:reference/sql/sql-indexes.adoc#sql-drop-index[`DROP INDEX`]
* xref:reference/sql/sql-indexes.adoc#sql-rebuild-index[`REBUILD INDEX`]
