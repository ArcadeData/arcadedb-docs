...
image:../../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/tutorials/run.adoc" float="right"]
...
For more information look at <<howto-high-availability,High Availability>>.

==== Getting Started

See <<installation,Installation>> for guides to install under Linux, MacOS, Windows.
Alternatively, you can run ArcadeDB using Docker:

[source,bash,subs="attributes+"]
----
docker run --rm -p 2424:2424 -p 2434:2434 -p 2480:2480 -p 5432:5432 \
