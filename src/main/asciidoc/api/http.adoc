...
In case <<SQL,SQL>> (`sql`) is supposed to be used as language for a transactions, the language variant <<sql-L<<sql-Script,E,SQL Script>> (`sqlscript`) is also available.
