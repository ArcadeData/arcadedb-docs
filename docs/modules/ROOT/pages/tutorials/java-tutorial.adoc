...
The entry point it's the `xref:reference/java-api/java-ref-database.adoc#databasefactory[DatabaseFactory]` class that allows to create and open a database.
...
NOTE: A `xref:reference/java-api/java-ref-database.adoc#databasefactory[DatabaseFactory]` object doesn't hold the `xref:concepts/databases.adoc#database-url[Database]` instances.
It's up to you to close them once you have finished.

=== Create a new database

To create a new database from scratch, use the `.create()` method in `xref:reference/java-api/java-ref-database.adoc#databasefactory[DatabaseFactory]` class.
...
The `xref:concepts/databases.adoc#database-url[Database]` instance extends Java7 `AutoClosable` interface, that means the database is closed automatically when the Database variable reaches out of the scope.
...
You have basically three ways to do that (xref:reference/java-api/java-ref-database.adoc#database-api[Java API], xref:reference/sql/chapter.adoc#sql[SQL], https://tinkerpop.apache.org/[Apache Gremlin] and https://opencypher.org/[Open Cypher]) each one with its pros/cons:

[cols=5]
|===
|
|xref:reference/java-api/java-ref-database.adoc#database-api[JVM Embedded API]
|xref:reference/sql/chapter.adoc#sql[SQL]
|xref:reference/gremlin/gremlin.adoc#gremlin-api[Apache Gremlin]
|xref:reference/cypher/chapter.adoc#cypher[Cypher]

|Speed|* * *|* *|* *|* *
|Flexibility|* * *|*|* *|* *
|xref:tutorials/embed-server.adoc#embedded-server[Embedded] mode|Yes|Yes|Yes|Yes
|Remote mode|No|Yes|Yes (through the xref:reference/gremlin/gremlin.adoc#gremlin-server[Gremlin Server] plugin)|Yes (through the xref:reference/gremlin/gremlin.adoc#gremlin-server[Gremlin Server] plugin)
|===
...
Since ArcadeDB is 100% compliant with Gremlin 3.7.x, you can run this query against the Apache xref:reference/gremlin/gremlin.adoc#gremlin-server[Gremlin Server] configured with ArcadeDB:
...
For more information about Apache Gremlin see: xref:reference/gremlin/gremlin.adoc#gremlin-api[Gremlin API] support
...
For more information about Cypher see: xref:reference/cypher/chapter.adoc#cypher[Cypher] support
