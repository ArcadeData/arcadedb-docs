[[JDBC]]
=== Connect with JDBC Driver image:../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/api/java-jdbc.adoc" float=right]
