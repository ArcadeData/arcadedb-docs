...
NOTE: To insert only documents, vertices, or edges with a certain *unique* property, use a xref:reference/sql/sql-indexes.adoc#sql-create-index[unique index].
