[[sql-functions]]
= Functions
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/sql/sql-functions.adoc" float=right]
...
See also: xref:reference/graph-algorithms/algorithms.adoc#algo-astar[Graph Algorithms: A*] for the Cypher procedure variant with geographic heuristics.
...
See also: xref:reference/graph-algorithms/algorithms.adoc#algo-dijkstra[Graph Algorithms: Dijkstra] for the Cypher procedure variant, and xref:reference/graph-algorithms/algorithms.adoc#algo-dijkstra-sql[] for the full SQL function reference in the appendix.
...
See also: xref:reference/graph-algorithms/algorithms.adoc#algo-shortest-path-sql[Graph Algorithms: shortestPath()] for the full function reference, and xref:reference/graph-algorithms/algorithms.adoc#appendix-graph-algorithms[Graph Algorithms Appendix] for a comprehensive reference of all graph algorithms.
