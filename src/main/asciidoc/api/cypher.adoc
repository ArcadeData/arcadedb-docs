...
ArcadeDB partially supports Open Cypher as query engine. It uses link:https://github.com/opencypher/cypher-for-gremlin[Cypher for Gremlin] under-the-hood which has stopped being supported a few years ago. There are a lot of things that work and a lot of nuances which don't. 
