...
----
ArcadeDB> CREATE VERTEX TYPE Document
ArcadeDB> CREATE PROPERTY Document.embedding ARRAY OF FLOATS
ArcadeDB> CREATE INDEX ON Document (embedding) LSM_VECTOR METADATA {dimensions: 100, similarity: 'COSINE'}
----
...
ArcadeDB> CREATE PROPERTY Image.featureVector ARRAY OF FLOATS
...
ArcadeDB> CREATE PROPERTY Product.attributes ARRAY OF FLOATS
...
ArcadeDB> CREATE PROPERTY CompactDoc.vec ARRAY OF FLOATS
...
ArcadeDB> CREATE PROPERTY VectorVertex.embedding ARRAY OF FLOATS
...
----
ArcadeDB> CREATE VERTEX TYPE Document
ArcadeDB> CREATE PROPERTY Document.content STRING
ArcadeDB> CREATE PROPERTY Document.embedding ARRAY OF FLOATS
ArcadeDB> CREATE PROPERTY Document.source STRING
ArcadeDB> CREATE INDEX ON Document (embedding) LSM_VECTOR METADATA {dimensions: 384, similarity: 'COSINE', maxConnections: 16, beamWidth: 100}
----

Then query for similar documents by source:

----
ArcadeDB> SELECT FROM Document WHERE source = 'wikipedia' AND vectorNeighbors('embedding', [0.1, 0.2, 0.3], 10) > 0.8
----
...
ArcadeDB> CREATE PROPERTY MultiModalRecord.imageEmbedding ARRAY OF FLOATS
ArcadeDB> CREATE PROPERTY MultiModalRecord.textEmbedding ARRAY OF FLOATS
...
ArcadeDB> CREATE PROPERTY Word.vector ARRAY OF FLOATS
