...
2. **Import into ArcadeDB**: Use the ArcadeDB xref:how-to/migration/orientdb-importer.adoc#orientdb-importer[OrientDB Importer] or the `IMPORT DATABASE` SQL command:
+
[source,sql]
----
...
For more details on importing, see the xref:how-to/migration/orientdb-importer.adoc#orientdb-importer[OrientDB Importer] section.
