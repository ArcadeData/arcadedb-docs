...
combines mutiple score form different vectors using a fusion method.
...
Returns integer argument number of vectors to an argument vector or key ident from an argument vector index.

Syntax: `vectorNeighbours(&lt;string&gt;, &lt;vector|string&gt;, &lt;integer&gt;)`

*Examples*

[source,sql]
----
SELECT vectorNeighbours('doc[myvector]', 'database', 5)
----
...
Syntax: `vectorIsNormalized(&lt;vector|field&gt;)`
...
Syntax: `vectorSccale(&lt;vector|field&gt;, &lt;scalar|field&gt;)`
...
Computes the standard deviance (square-root of varince) of an argument vector.
...
Syntax: `vectorSub(&lt;vector|field&gt;, &lt;vector|field&gt;)`
