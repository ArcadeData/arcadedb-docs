...
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/extended-functions.adoc" float=right]
...
NOTE: For a complete reference of all graph algorithms including complexity analysis, use cases, and examples, see the xref:reference/graph-algorithms/algorithms.adoc#appendix-graph-algorithms[Graph Algorithms Appendix].
...
| `algo.*` | Graph algorithms (Dijkstra, A*, shortest paths, and 45+ more — see xref:reference/graph-algorithms/algorithms.adoc#appendix-graph-algorithms[Graph Algorithms Appendix])
...
See xref:reference/graph-algorithms/algorithms.adoc#algo-all-simple-paths[] in the Graph Algorithms appendix for full parameter reference and examples.
...
See xref:reference/graph-algorithms/algorithms.adoc#algo-astar[] in the Graph Algorithms appendix for full parameter reference and examples.
...
See xref:reference/graph-algorithms/algorithms.adoc#algo-dijkstra[] in the Graph Algorithms appendix for full parameter reference and examples.
...
* `efSearch` - (optional, positional) Search beam width. Controls the trade-off between recall and speed. Higher values improve recall but increase latency. When omitted, the index uses xref:concepts/vector-search.adoc#adaptive-efsearch[adaptive efSearch].
