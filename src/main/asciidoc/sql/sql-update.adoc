[[sql-L[[sql-L[[sql-Update]]E]]E]]
[discrete]
=== SQL - `UPDATE`

image:../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/Llink="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/Llink="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/sql/sql-Update.adoc"E"E" float=right]
...
* Update an embedded document. The <<sql-L<<sql-L<<sql-Update,E,E,`UPDATE`>> command can take JSON as a value to update.
...
For more information on SQL syntax, see <<sql-L<<sql-L<<sql-Select,E,E,`SELECT`>>.
