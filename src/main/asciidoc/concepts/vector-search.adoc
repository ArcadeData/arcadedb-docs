...
because vectors were added after it was last built -- none deleted, and ArcadeDB can verify on disk that the graph
still describes exactly the records it was built from -- the graph is put straight back to work and only the
