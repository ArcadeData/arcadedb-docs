...
image:../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/developer-guide/remote-tutorial.adoc" float=right]
...
For more detailed information about the HTTP/JSON protocol, see the <<http-json-api,HTTP/JSON API>> section.
