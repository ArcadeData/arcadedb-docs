...
*Per-query* (highest priority) -- pass as the 4th argument to `vectorNeighbors()`:

[source,sql]
----
-- Higher efSearch for a critical query that needs maximum recall
SELECT vectorNeighbors('Doc[embedding]', [...], 10, 500)

-- Lower efSearch for a latency-sensitive query
SELECT vectorNeighbors('Doc[embedding]', [...], 10, 30)
----
