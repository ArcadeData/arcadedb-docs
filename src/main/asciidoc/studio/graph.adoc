...
[%header,cols="50%,50%"]
|===
|image:../images/studio-graph-node-menu-unselected.png[align="left",scaledwidth=40%]|Hold the selection on a node to show its context menu.
Then while still holding the selection, slide on the action to execute and then release the selection.|image:../images/studio-graph-node-menu-selected.png[align="right",scaledwidth=40%]
|===
