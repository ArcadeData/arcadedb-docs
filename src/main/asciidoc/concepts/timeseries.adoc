...
A sample can be `NaN`, which means "no measurement here" rather than a value of zero. Aggregations treat it that
way:
...
A Grafana panel therefore draws a gap for such a bucket rather than a dip to zero.
