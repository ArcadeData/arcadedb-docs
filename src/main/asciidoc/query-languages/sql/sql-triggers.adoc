...
[discrete]
=== Triggers
image:../images/edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/query-languages/sql/sql-triggers.adoc" float=right]
...
* <<sql-custom-functions,Custom Functions>>
