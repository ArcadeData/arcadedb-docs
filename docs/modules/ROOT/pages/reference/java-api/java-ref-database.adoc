...
It returns an instance of `xref:reference/java-api/java-ref-database-async.adoc#databaseasyncexecutor[DatabaseAsyncExecutor]` to execute asynchronous calls.
...
Returns a `Select` builder to construct and execute queries using the xref:reference/java-api/java-select-api.adoc#java-select-api[Native Select API].
...
See the xref:reference/java-api/java-select-api.adoc#java-select-api[Native Select API] documentation for the full reference including operators, graph traversal, and vector search.
