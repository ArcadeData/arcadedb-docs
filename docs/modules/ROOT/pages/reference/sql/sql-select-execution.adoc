...
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/sql/sql-select-execution.adoc" float=right]
...
* xref:reference/sql/sql-select.adoc#sql-select-unwind[`UNWIND`] projections
...
To display the execution plan of a query, without executing it, you can just execute the query prefixing it with xref:reference/sql/sql-explain.adoc#sql-explain[`EXPLAIN`], eg.
