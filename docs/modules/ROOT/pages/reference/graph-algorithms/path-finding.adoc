...
See also: xref:reference/graph-algorithms/sql-path-functions.adoc#algo-dijkstra-sql[] for the SQL function variant, and xref:reference/sql/sql-functions.adoc#astar[astar()] / xref:reference/sql/sql-functions.adoc#dijkstra[dijkstra()] for the SQL function equivalents.
...
See also: xref:reference/graph-algorithms/sql-path-functions.adoc#algo-bellman-ford-sql[] for the SQL function variant.
...
See also: xref:reference/graph-algorithms/structural-analysis.adoc#algo-topological-sort[] for topological ordering.
