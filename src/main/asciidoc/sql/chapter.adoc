...
| <<_traversedvertex,traversedVertex()>> | <<_median,median()>> |   |   |  <<_expand,expand()>>
| <<_traversededge,traversedEdge()>> | <<_decimal,decimal()>> |  |   | 
| <<_shortestpath,shortestPath()>> | <<_percentile,percentile()>> | |   |
