[[geospatial]]
= Geospatial Index
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/how-to/data-modeling/geospatial.adoc" float=right]
...
NOTE: Changing precision after data has been indexed requires rebuilding the index with xref:reference/sql/sql-rebuild-index.adoc#sql-rebuild-index[`REBUILD INDEX`].
...
* xref:reference/sql/sql-rebuild-index.adoc#sql-rebuild-index[`REBUILD INDEX`]
