...
| <<SQL-Match,MATCH>> | <<SQL-Drop-Bucket,DROP BUCKET>> | <<SQL-Create-Index,CREATE INDEX>>
| <<SQL-Traverse,TRAVERSE>> | <<SQL-Truncate-Bucket,TRUNCATE BUCKET>> | <<_sql-rebuild-index,REBUILD INDEX>>
| *Planning* | <<SQL-Create-Property,CREATE PROPERTY>> | <<SQL-Drop-Index,DROP INDEX>>
| <<SQL-Explain,EXPLAIN>> | <<SQL-Alter-Property,ALTER PROPERTY>> | *System*
| <<SQL-Profile,PROFILE>> | <<SQL-Drop-Property,DROP PROPERTY>> | <<SQL-Console,CONSOLE>>
|===
...
|<<_asdatetime,asDateTime()>>|<<_lastindexof,lastIndexOf()>>|<<_keys,keys()>>| |<<_tojson,toJSON()>>
|<<_asdecimal,asDecimal()>>|<<_left,left()>>|<<_values,values()>>| |<<_hash,hash()>>
