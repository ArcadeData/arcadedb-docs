[[swagger-ui]]
= Swagger-UI
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/tools/swaggerui.adoc" float=right]
...
With the Swagger UI you can hands-on explore the xref:reference/http-api/http.adoc#http-json-api[HTTP API] and test requests.
