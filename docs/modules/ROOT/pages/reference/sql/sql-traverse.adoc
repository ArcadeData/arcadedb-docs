...
While you can use the <<sql-traverse,`TRAVERSE`>> command with any domain model, it provides the greatest utility with the xref:concepts/multi-model.adoc#graph-model[Graph Model].
