[[sql-introduction]]
= Introduction
image:edit.png[link="https://github.com/ArcadeData/arcadedb-docs/blob/main/src/main/asciidoc/reference/sql/sql-introduction.adoc" float=right]
...
|===
| Postgres | ArcadeDB
| `CREATE TABLE` | xref:reference/sql/sql-create-type.adoc#sql-create-type[`CREATE TYPE`]
| `ALTER TABLE` | xref:reference/sql/sql-alter-type.adoc#sql-alter-type[`ALTER TYPE`]
| `ADD COLUMN` | xref:reference/sql/sql-create-property.adoc#sql-create-property[`CREATE PROPERTY`]
| `ALTER COLUMN` | xref:reference/sql/sql-alter-property.adoc#sql-alter-property[`ALTER PROPERTY`]
