...
By clicking on the xref:concepts/basics.adoc#rid[RecordID (RID)] (always the first column), the record will be displayed in the graph view with all its attributes.
